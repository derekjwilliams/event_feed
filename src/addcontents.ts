...
const eventUrls: string[] = [
  ...
  //  // 'https://events.willamette.edu/e/5719',
  // 'https://events.willamette.edu/e/6414',
  // 'https://events.willamette.edu/e/6189',
  // 'https://events.willamette.edu/e/6396',
  // 'https://events.willamette.edu/e/6376',
  // 'https://events.willamette.edu/e/6397',
  // 'https://events.willamette.edu/e/6151',
  // 'https://events.willamette.edu/e/6181',
  // 'https://events.willamette.edu/e/6188',
  // 'https://events.willamette.edu/e/5011',
  // 'https://events.willamette.edu/e/5001',
  // 'https://events.willamette.edu/e/6399',
  // 'https://events.willamette.edu/e/6377',
  // 'https://events.willamette.edu/e/5002',
  // 'https://events.willamette.edu/e/6401',
  // 'https://events.willamette.edu/e/6417',
  // 'https://events.willamette.edu/e/6190',
  // 'https://events.willamette.edu/e/5006',
  // 'https://events.willamette.edu/e/6418',
  // 'https://events.willamette.edu/e/6455',
  // 'https://events.willamette.edu/e/6456',
  // 'https://events.willamette.edu/e/6457',
  // 'https://events.willamette.edu/e/6458',
  ...
  // 'https://events.willamette.edu/e/6459',
  // 'https://events.willamette.edu/e/6191',
  // 'https://events.willamette.edu/e/6460',
  // 'https://events.willamette.edu/e/6461',
  // 'https://events.willamette.edu/e/6462',
  // 'https://events.willamette.edu/e/6463',
  // 'https://events.willamette.edu/e/6464',
  ...
  // 'https://events.willamette.edu/e/6466',
  // 'https://events.willamette.edu/e/5009',
  // 'https://events.willamette.edu/e/6467',
  // 'https://events.willamette.edu/e/6468',
  // 'https://events.willamette.edu/e/6469',
  // 'https://events.willamette.edu/e/6470',
  ...
  try {
    ...
    dateElement.contents().each((index, node) => {
      if (node.type === 'tag' && node.name === 'br') {
        ...
        // console.log(dateElement.contents())
        const nextNode = dateElement.contents().eq(index + 1)
        // console.log(nextNode.length)
        // if (nextNode.length) {
        //   console.log(nextNode[0].type)
    ...
    // console.log('day and time block: ', dayAndTime)
    const parts = dayAndTime.split('\t')
    console.log('day and time parts: ', parts)
    const length = parts.length
    const timeParts = parts[length - 1].trim().split('–')
...
const processEvents = async () => {
  ...
  for (const url of eventUrls) {
    ...
    if (contentAndTimes) {
      ...
      // console.log('timeParts: ', contentAndTimes.timeParts)
      if (contentAndTimes.timeParts && contentAndTimes.timeParts.length === 2) {
        console.log('content and times: ', contentAndTimes.timeParts)
        const startTimeString = convertTime(contentAndTimes.timeParts[0].trim())
        const endTimeString = convertTime(contentAndTimes.timeParts[1].trim())
        ...
        const endTimeSqlUpdate = `UPDATE events SET event_end_date = (event_start_date::date + TIME '${endTimeString}') AT TIME ZONE 'America/Los_Angeles' WHERE link = '${eventLink}';`
